      ...
      templates: [
            {
                ...
                payload: JSON.stringify({ type: "Software Context", identifier: "ss-internet-banking" })
            },
            {
                ...
                payload: JSON.stringify({ type: "Container", identifier: "ss-internet-banking" })
            },
            {
                ...
                payload: JSON.stringify({ type: "Component", identifier: "con-api-application" })
            }
        ]
    },
    {
        ...
        templates: [
            {
                ...
                payload: JSON.stringify({ type: "System Landscape", identifier: "" })
            },
            {
                ...
                payload: JSON.stringify({ type: "Dynamic", identifier: "" })
            },
            {
