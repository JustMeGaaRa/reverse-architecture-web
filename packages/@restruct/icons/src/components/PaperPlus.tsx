export const PaperPlus = () => {
    return (
        <svg width="24px"  height="24px"  viewBox="0 0 24 24"  fill="none" color="currentColor"  version="1.1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink">
...
export const UnsuccessDocument = () => {
    return (
...
export const Categories = () => {
    return (
        <svg width="24" height="24" viewBox="0 0 26 24" fill="none" color="currentColor" xmlns="http://www.w3.org/2000/svg">
