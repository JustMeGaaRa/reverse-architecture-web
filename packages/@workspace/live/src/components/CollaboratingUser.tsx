...
export const UserMouseCursor: FC<{
    ...
    const [ fill, background, color ] = useToken("colors", [`${colorScheme}.500`, `${colorScheme}.200`, `${colorScheme}.900`]);
