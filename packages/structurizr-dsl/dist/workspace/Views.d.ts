...
export declare function toViewsString(views: Views): string;
export declare function views(systemContexts?: SystemContextView[], containers?: ContainerView[], components?: ComponentView[], deployments?: DeploymentView[], styles?: Styles): Views;
