...
export class Configuration {
    public constructor(private readonly propertiesMap: Y.Map<unknown>) {
        ...
        if (!propertiesMap.has("themes")) propertiesMap.set("themes", new Y.Array<unknown>());
    }
...
export class Styles {
    ...
    public constructor(private readonly propertiesMap: Y.Map<unknown>) {
        if (!propertiesMap.has("elements")) propertiesMap.set("elements", new Y.Array<Y.Map<unknown>>());
        if (!propertiesMap.has("relationships")) propertiesMap.set("relationships", new Y.Array<Y.Map<unknown>>());
    }
